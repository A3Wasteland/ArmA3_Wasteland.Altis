...
[
	...
	player addAction ["<img image='client\icons\money.paa'/> Pickup Money", "client\actions\pickupMoney.sqf", [], 1, false, false, "", "count nearestObjects [player, ['Land_Money_F'], 2] > 0"],
