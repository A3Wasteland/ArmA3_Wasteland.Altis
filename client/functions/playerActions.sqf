...
//Cancel action
aActionsIDs = aActionsIDs + [player addAction[("<img image=""client\icons\cancel.paa""/><t color=""#FFFFFF""> Cancel Action</t>"), "noscript.sqf", 'doCancelAction = true;', 1, false, false, "", 'mutexScriptInProgress']];
