...
[MF_ITEMS_CANNED_FOOD, "Snack Food", {50 call mf_items_survival_eat}, A3W_foodObject,"client\icons\cannedfood.paa", 5] call mf_inventory_create;
[MF_ITEMS_WATER, "Water Container", {50 call mf_items_survival_drink}, A3W_drinkObject,"client\icons\water.paa", 5] call mf_inventory_create;
...
// Take Water from Blue water container
[] call {
    private["_label", "_code", "_condition"];
