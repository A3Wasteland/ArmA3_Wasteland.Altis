...
#define idc_objectSearchDialog 55600
...
class tw_RscShortcutButtonMain
{
	idc = -1;
	style = 0;
	default = 0;
...
class ObjectSearch
{
	...
	class ControlsBackground
	{
		class ObjectSearchTitleBar: tw_RscText
		{
			...
			w = 0.8;
			h = 0.04;
			colorBackground[] = {0.2,0.5,0.2,0.7};
		};
		...
		class ObjectSearchMainBackground: tw_RscText
		{
			idc = -1;
	...
	class Controls
	{
		class ObjectSearchFindButton: tw_RscButton
		{
		...
		class ObjectSearchObjectList: tw_RscListbox
		{
			idc = idc_objectSearchObjectList;
			x = 5 * GUI_GRID_W + GUI_GRID_X;
