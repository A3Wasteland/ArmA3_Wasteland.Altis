...
[
	...
	["Nightstalker Sight","optic_Nightstalker", 350,"item"],
...
[
	//["TERRITORY_MARKER_NAME", "HUMAN DESCRIPTIVE NAME", MONETARY_VALUE, "TYPE"],
	["TERRITORY_AIRPORT_TEST", "Main Airport", 500, "AIRFIELD"];
];
