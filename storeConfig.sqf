...
[
	["RPG-7", "launch_RPG7_F", 4000],
	["RPG-42 Alamut", "launch_RPG32_F", 5000],
	["RPG-42 Alamut (G Hex)", "launch_RPG32_ghex_F", 6000, "noDLC"],
...
[
	...
	["Static Titan AT 4Rnd", "B_static_AT_F", 7500], // Static launchers only have 4 ammo, hence the low price
	["Static Titan AT 4Rnd", "O_static_AT_F", 7500],
	["Static Titan AT 4Rnd", "I_static_AT_F", 7500],
	["Static Titan AA 4Rnd", "B_static_AA_F", 8000],
	["Static Titan AA 4Rnd", "O_static_AA_F", 8000],
	["Static Titan AA 4Rnd", "I_static_AA_F", 8000],
	["Mk30 HMG .50 Low tripod", "B_HMG_01_F", 6000],
	["Mk30 HMG .50 Low tripod", "O_HMG_01_F", 6000],
	["Mk30 HMG .50 Low tripod", "I_HMG_01_F", 6000],
	// ["Mk30A HMG .50 Sentry", "B_HMG_01_A_F", 15000], // "A" = Autonomous = Overpowered
	...
	["Mk32 GMG 20mm Low tripod", "B_GMG_01_F", 10000],
	["Mk32 GMG 20mm Low tripod", "O_GMG_01_F", 10000],
	["Mk32 GMG 20mm Low tripod", "I_GMG_01_F", 10000],
	// ["Mk32A GMG 20mm Sentry", "B_GMG_01_A_F", 60000],
	// ["Mk32A GMG 20mm Sentry", "O_GMG_01_A_F", 60000],
	// ["Mk32A GMG 20mm Sentry", "I_GMG_01_A_F", 60000],
	...
	["Mk6 Mortar", "B_Mortar_01_F", 50500],
	["Mk6 Mortar", "O_Mortar_01_F", 50500],
	["Mk6 Mortar", "I_Mortar_01_F", 50500]
];

throwputArray = compileFinal str
[
	["RGN Mini Grenade", "MiniGrenade", 250],
	["RGO Frag Grenade", "HandGrenade", 350],
	["APERS Tripwire Mine", "APERSTripMine_Wire_Mag", 1000],
	["APERS Bounding Mine", "APERSBoundingMine_Range_Mag", 2500],
	["APERS Mine", "APERSMine_Range_Mag", 3000],
	["Claymore Charge", "ClaymoreDirectionalMine_Remote_Mag", 950],
	["M6 SLAM Mine", "SLAMDirectionalMine_Wire_Mag", 950],
...
[
	...
	["PG-7VM HEAT Grenade", "RPG7_F", 600],                   // Direct damage: medium    | Splash damage: low    | Guidance: none
	["RPG-42 Anti-Tank Rocket", "RPG32_F", 600],              // Direct damage: high      | Splash damage: low    | Guidance: none
	["RPG-42 High-Explosive Rocket", "RPG32_HE_F", 600],      // Direct damage: medium    | Splash damage: medium | Guidance: none
	["PCML Anti-Tank Missile", "NLAW_F", 700],                // Direct damage: very high | Splash damage: low    | Guidance: laser, ground vehicles
...
[
	...
	["Light Ghillie", "U_O_GhillieSuit", 1000, "uni"],
