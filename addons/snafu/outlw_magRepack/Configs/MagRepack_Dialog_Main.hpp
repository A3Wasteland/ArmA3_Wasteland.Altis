...
class MagRepack_Dialog_Main
{
	...
	class Controls
	{
		...
		class MR_Logo: outlw_MR_RscPicture
		{
			...
			text = "addons\snafu\outlw_magRepack\Images\MR_logo.paa";
		...
		*/
		...
		{
			idc = 2210;
			text = "addons\snafu\outlw_magRepack\Images\MR_SourceGradient.paa";
		...
		{
			idc = 2211;
			text = "addons\snafu\outlw_magRepack\Images\MR_TargetGradient.paa";
