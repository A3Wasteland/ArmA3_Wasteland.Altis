if ((getPlayerUID player) in (call adminbaseIDArray)) then {
titleText ["Willkommen in der unserer Adminbasis", "PLAIN DOWN", 3]; titleFadeOut 4;
}
else{
// Everyone Else
