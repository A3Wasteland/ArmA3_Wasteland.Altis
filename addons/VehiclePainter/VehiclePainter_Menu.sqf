...
// ******************************************************************************************
//	@file Version: 1.0
//	@file Name: VehiclePainter_Menu.sqf
//	@file Author: LouD
...
if (!isNil "_uid") then 
{
	_start = createDialog "VehPaint_Menu";

	_displayPaint = uiNamespace getVariable "VehPaint_Menu";
	_colorlist = _displayPaint displayCtrl VehPaint_Menu_option;
	lbClear _colorlist;
