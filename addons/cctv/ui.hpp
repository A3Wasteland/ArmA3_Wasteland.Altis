...
class cctv_ui_RscPictureKeepAspect: cctv_ui_RscPicture {
	style = "0x30 + 0x800";
};

class cctv_ui_RscBackgroundPicture {
	type              = CT_STATIC;
	idc               =  -1;
	style             = ST_PICTURE;
	colorBackground[] = {0,0,0,0};
...
class cctv_ui_RscDummy : cctv_ui_RscButton {
	x   = -1.0;
	y   = -1.0;
	idc = -1;
	w   = 0.01;
...
class cctv_ui_RscEditMulti : cctv_ui_RscEdit {
	style = ST_MULTI;
	sizeEx = 0.03;
	lineSpacing = 1;
...
class cctv_ui_RscListNBox : cctv_ui_RscListBox {
	type = CT_LISTNBOX;
	colorSelect[] = {1,1,1,1};
	colorText[] = {1,1,1,1};
	colorBackground[] = {0,0,0,0.15};
