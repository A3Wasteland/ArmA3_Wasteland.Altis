...
class ui_RscPictureKeepAspect: ui_RscPicture {
	style = "0x30 + 0x800";
};

class ui_RscBackgroundPicture {
	type              = CT_STATIC;
	idc               =  -1;
	style             = ST_PICTURE;
	colorBackground[] = {0,0,0,0};
...
class ui_RscDummy : ui_RscButton {
	x   = -1.0;
	y   = -1.0;
	idc = -1;
	w   = 0.01;
...
class ui_RscEditMulti : ui_RscEdit {
	style = ST_MULTI;
	sizeEx = 0.03;
	lineSpacing = 1;
...
class ui_RscListNBox : ui_RscListBox {
	type = CT_LISTNBOX;
	colorSelect[] = {1,1,1,1};
	colorText[] = {1,1,1,1};
	colorBackground[] = {0,0,0,0.15};
