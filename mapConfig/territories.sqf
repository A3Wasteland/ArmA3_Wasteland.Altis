...
[
	["TERRITORY_0_KAVALA_A", "Kavala (A)", 7500],
	["TERRITORY_0_KAVALA_B", "Kavala (B)", 7500],
	["TERRITORY_0_KAVALA_C", "Kavala (C)", 7500],
	["TERRITORY_1_ALTISAIR_A", "Altis Airport (A)", 7500],
	["TERRITORY_1_ALTISAIR_B", "Altis Airport (B)", 7500],
	["TERRITORY_1_ALTISAIR_C", "Altis Airport (C)", 7500],
	["TERRITORY_2_PYRGOS_A", "Pyrgos (A)", 7500],
	["TERRITORY_2_PYRGOS_B", "Pyrgos (B)", 7500],
	["TERRITORY_2_PYRGOS_C", "Pyrgos (C)", 7500],
	["TERRITORY_3_SELAKANO_A", "SELAKANO (A)", 7500],
	["TERRITORY_3_SELAKANO_B", "SELAKANO (B)", 7500],
	["TERRITORY_3_SELAKANO_C", "SELAKANO (C)", 7500],
	["TERRITORY_4_KORE_A", "KORE (A)", 7500],
	["TERRITORY_4_KORE_B", "KORE (B)", 7500],
	["TERRITORY_4_KORE_C", "KORE (C)", 7500]
