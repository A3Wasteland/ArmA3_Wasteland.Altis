...
_setupObjects =
{
	...
	_randomBox = selectRandom ["mission_ApexRifles"];
	_randomBox2 = selectRandom ["mission_CompactLauncher","mission_DLCLMGs"];
	...
	_missionHintText = format ["Traficantes de armas e drogas assumiram <br/><t size='1.25' color='%1'>%2</t><br/><br/>parece haver <t color='%1'>%3 meliantes</t> se escondendo dentro ou no topo dos edifícios. Se livrar de todos eles e tomar seus arsenais e drogas!<br/>Cuidado com as JANELAS!", sideMissionColor, _townName, _nbUnits];
};
...
_successExec =
{
	...
	_successHintMessage = format ["Bom trabalho!<br/><br/><t color='%1'>%2</t><br/>é um lugar seguro novamente!<br/>Aproveite o arsenal!", sideMissionColor, _townName];
