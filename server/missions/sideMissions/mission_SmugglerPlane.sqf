...
_setupObjects =
{
	...
	//_vehicles set [0, [_veh1,[14321.6,15857.7,0], 14, _aiGroup] call _createVehicle]; // static value update when porting to different maps 7th
	...
	_missionHintText = format ["Um <t color='%2'>%1</t> esta transportando armas roubadas e dinheiro. Derrubá-lo e matar o piloto para recuperar o dinheiro e as armas!", _vehicleName, sideMissionColor];
...
_successExec =
{
	...
	for "_i" from 1 to 10 do
	{
		...
		_cash setVariable ["cmoney", 500, true];
	...
	/*_Boxes1 = ["mission_CompactLauncher","airdrop_Snipers1"];
	_currBox1 = _Boxes1 call BIS_fnc_selectRandom;
	_box1 = createVehicle [_currBox1, _lastPos, [], 2, "None"];
	_box1 setDir random 360;
	_box1 allowDamage false;
	
	_Boxes2 = ["airdrop_LMGs","airdrop_Rifles"];
	_currBox2 = _Boxes2 call BIS_fnc_selectRandom;
	_box2 = createVehicle [_currBox2, _lastPos, [], 2, "None"];
	_box2 setDir random 360;
	_box2 allowDamage false;
	
	_Boxes3 = ["Box_Syndicate_WpsLaunch_F","Box_Syndicate_Wps_F","mission_USLaunchers","mission_Uniform"];
