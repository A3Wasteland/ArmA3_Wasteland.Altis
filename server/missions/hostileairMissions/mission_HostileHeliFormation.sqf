...
_setupObjects =
{
	...
	_missionHintText = format ["Uma formação de helicópteros armados contendo <t color='%3'>%1</t> e dois <t color='%3'>%2</t> estão patrulhando Altis. Destruí-los e recuperar a sua carga!", _vehicleName, _vehicleName2, hostileairMissionColor];
...
_successExec =
{
	...
	_successHintMessage = "Helicopteros derrubados. Muito bem!";
};
