...
_setupObjects =
{
	...
	_missionHintText = format ["Traficantes de drogas foram vistos dirigindo um <t color='%2'>%1</t>. Detê-los e recuperar rapidamente as suas drogas e dinheiro!", _vehicleName, mainMissionColor];
...
_successExec =
{
	...
	_successHintMessage = "Você parou os traficantes de drogas. As drogas e dinheiro são seus!";
};
