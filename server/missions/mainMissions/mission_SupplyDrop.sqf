...
_successExec =
{
	...
	_Boxes1 = ["mission_snipers","mission_AssRifles","airdrop_DLC_LMGs","mission_Uniform"];
	_currBox1 = _Boxes1 call BIS_fnc_selectRandom;
	_box1 = createVehicle [_currBox1, _lastPos, [], 2, "None"];
	_box1 setDir random 360;
	_box1 allowDamage false;
	
	_Boxes2 = ["mission_snipers","mission_AssRifles","airdrop_DLC_LMGs","mission_UniformF"];
	_currBox2 = _Boxes2 call BIS_fnc_selectRandom;
	_box2 = createVehicle [_currBox2, _lastPos, [], 2, "None"];
	_box2 setDir random 360;
	_box2 allowDamage false;
	
	_Boxes3 = ["mission_snipers","mission_AssRifles","airdrop_DLC_LMGs","mission_Uniform"];
	_currBox3 = _Boxes3 call BIS_fnc_selectRandom;
	_box3 = createVehicle [_currBox3, _lastPos, [], 2, "None"];
	_box3 setDir random 360;
	_box3 allowDamage false;
	
	/*_Boxes4 = ["mission_snipers","mission_AssRifles","airdrop_DLC_LMGs","mission_Uniform"];
	...
	_Boxes5 = ["mission_snipers","mission_AssRifles","airdrop_DLC_LMGs","mission_Uniform"];
	...
	_Boxes6 = ["mission_snipers","mission_AssRifles","airdrop_DLC_LMGs","mission_Uniform"];
	...
	_Boxes7 = ["mission_snipers","mission_AssRifles","airdrop_DLC_LMGs","mission_Uniform"];
	...
	_Boxes8 = ["mission_snipers","mission_AssRifles","airdrop_DLC_LMGs","mission_Uniform"];
	...
	_Boxes9 = ["mission_snipers","mission_AssRifles","airdrop_DLC_LMGs","mission_Uniform"];
