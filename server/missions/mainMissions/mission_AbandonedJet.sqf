...
_setupObjects =
{
	...
	[_aiGroup,_missionPos,24,28] spawn createCustomGroup3;
	...
	_missionHintText = format ["%1 <t color='%3'>%2</t> foi imobilizado, recupere-o!", _vehDeterminer, _vehicleName, mainMissionColor];	
};
...
_successExec =
{
	...
	_successHintMessage = format ["O %1 foi recuperado, muito bem.", _vehicleName];
};
