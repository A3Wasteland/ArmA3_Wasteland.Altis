...
_vehicleClass = ["B_MBT_01_cannon_F","O_MBT_02_cannon_F","B_MBT_01_mlrs_F"] call BIS_fnc_selectRandom;
...
if(_result == 1) then
{
	...
	deleteGroup CivGrpM;
    	_hint = parseText format ["<t align='center' color='%4' shadow='2' size='1.75'>Objective Complete</t><br/><t align='center' color='%4'>------------------------------</t><br/><t align='center' color='%5' size='1.25'>%1</t><br/><t align='center'><img size='5' image='%2'/></t><br/><t align='center' color='%5'>The MBT has been captured, you can now repair and refuel it. Good work!</t>", _missionType, _picture, _vehicleName, successMissionColor, subTextColor];
	[_hint] call hintBroadcast;
	//Reset the mission spawn bool
