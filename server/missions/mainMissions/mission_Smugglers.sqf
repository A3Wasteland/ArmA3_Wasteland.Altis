...
_setupObjects =
{
	...
	_boxes1 = selectRandom ["Box_FIA_Wps_F","Box_FIA_Ammo_F"];
	_randomBox = selectRandom ["mission_USLaunchers","mission_DLCLMGs","mission_ApexRifles"];
	...
	_boxes2 = selectRandom ["Box_FIA_Wps_F","Box_FIA_Ammo_F"];
	_randomBox2 = selectRandom ["mission_USSpecial","mission_DLCRifles","mission_HVLaunchers"];
	...
	_missionHintText = format ["Um grupo de contrabandistas foram vistos negociando armas e drogas. Pare a negociação e tomem suas armas e drogas.", mainMissionColor];
};
...
_successExec =
{
	...
	_successHintMessage = format ["Os contrabandistas estão mortos. Armas e drogas são suas!"];
};
