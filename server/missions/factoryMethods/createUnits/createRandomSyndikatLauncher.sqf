...
private ["_soldierTypes", "_uniformTypes", "_vestTypes", "_weaponTypes", "_group", "_position", "_rank", "_soldier", "_face", "_voice", "_backpack"];
...
_backpack = ["B_Kitbag_cbr_Bandit_2_F", "B_Kitbag_rgr_Para_8_F"];
...
_soldier addBackpack (_backpack call BIS_fnc_selectRandom);
...
for "_i" from 1 to 5 do {_soldier addItemToBackpack "RPG7_F";};
