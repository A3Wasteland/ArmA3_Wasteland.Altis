...
_soldier addBackpack "B_AssaultPack_rgr_CTRGLAT_F";
for "_i" from 1 to 2 do {_soldier addItemToBackpack "NLAW_F";};
...
_soldier addWeapon "launch_NLAW_F";
...
_soldier setFace "AfricanHead_02";
