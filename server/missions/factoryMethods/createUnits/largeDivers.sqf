...
// Rifleman
_leader = _group createUnit ["C_man_polo_1_F", [(_pos select 0) + 10, _pos select 1, _pos select 2], [], 1, "Form"];
...
// Rifleman
_man2 = _group createUnit ["C_man_polo_2_F", [(_pos select 0) + 10, _pos select 1, _pos select 2], [], 1, "Form"];
...
// Rifleman
_man3 = _group createUnit ["C_man_polo_3_F", [(_pos select 0) + 10, _pos select 1, _pos select 2], [], 1, "Form"];
...
// Rifleman
_man4 = _group createUnit ["C_man_polo_4_F", [(_pos select 0) + 10, _pos select 1, _pos select 2], [], 1, "Form"];
...
// Rifleman
_man5 = _group createUnit ["C_man_polo_5_F", [(_pos select 0) + 10, _pos select 1, _pos select 2], [], 1, "Form"];
...
// Rifleman
_man6 = _group createUnit ["C_man_polo_4_F", [(_pos select 0) + 10, _pos select 1, _pos select 2], [], 1, "Form"];
