...
for "_i" from 1 to 2 do {_soldier addItemToUniform "30Rnd_556x45_Stanag_Tracer_Red";};
_soldier addItemToUniform "30Rnd_556x45_Stanag_red";
...
_soldier addItemToVest "SmokeShellBlue";
_soldier addItemToVest "SmokeShellOrange";
...
_soldier setFace "WhiteHead_12";
_soldier setSpeaker "Male10ENG";
