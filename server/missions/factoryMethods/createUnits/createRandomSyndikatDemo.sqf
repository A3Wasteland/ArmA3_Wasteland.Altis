...
_soldierTypes = ["I_C_Soldier_Bandit_7_F", "I_C_Soldier_Para_7_F", "I_C_Soldier_Para_2_F", "I_C_Soldier_Bandit_3_F", "I_C_Soldier_Bandit_2_F", "I_C_Soldier_Para_3_F", "I_C_Soldier_Para_4_F", "I_C_Soldier_Para_6_F", "I_C_Soldier_Para_8_F", "I_C_Soldier_Bandit_5_F", "I_C_Soldier_Bandit_6_F", "I_C_Soldier_Bandit_1_F", "I_C_Soldier_Para_1_F", "I_C_Soldier_Para_5_F", "I_C_Soldier_Bandit_8_F", "I_C_Soldier_Bandit_4_F"];
...
_backpack = ["B_Kitbag_cbr_Bandit_2_F", "B_Kitbag_rgr_Para_8_F", "B_FieldPack_cb_Bandit_3_F", "B_FieldPack_khk_Bandit_1_F", "B_FieldPack_blk_Bandit_8_F"];
...
for "_i" from 1 to 3 do {_soldier addItemToBackpack "DemoCharge_Remote_Mag";};
_soldier addItemToBackpack "SatchelCharge_Remote_Mag";
for "_i" from 1 to 2 do {_soldier addItemToBackpack "APERSTripMine_Wire_Mag";};
for "_i" from 1 to 2 do {_soldier addItemToBackpack "APERSMine_Range_Mag";};
