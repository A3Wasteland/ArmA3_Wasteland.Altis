...
_setupObjects =
{
	...
	_missionHintText = format ["A GeoCache has been marked on the map. There is a small object hidden near the marker. Find it and a reward will be delivered by air!", extraMissionColor];
};
