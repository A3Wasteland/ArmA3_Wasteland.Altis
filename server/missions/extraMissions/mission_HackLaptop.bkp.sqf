...
private ["_bunker", "_laptop", "_table", "_obj", "_randomGroup", "_vehicleName"];
...
_setupObjects =
{
	...
	_vehicleName = "Laptop";
	_missionHintText = format ["A <t color='%2'>%1</t> with enemy bank accounts has been spotted, go hack it.", _vehicleName, _moneyText, moneyMissionColor];
};
