...
A3W_vehicleMaxUnusedTime = 8;      // Maximum time in hours that a vehicle can be left abandoned, after X hours of being abandoned, it will not be saved anymore (0 = no limit)
