...
A3W_remoteBombStoreRadius = 30;    // Prevent players from placing remote explosives within this distance from any store (0 = disabled)
...
A3W_payrollAmount = 2000;           // Amount of money rewarded per territory on each payroll
