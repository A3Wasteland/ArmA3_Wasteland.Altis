...
private ["_vehicle", "_realBoundingBoxes", "_boundingBoxReal"];
_vehicle = _this;
...
[
	...
	["C_Van_01_fuel_F", [[-1.2,-3.3,-1.9],[1.2,2.2,1.1]]],
	["I_G_Van_01_fuel_F", [[-1.2,-3.3,-1.9],[1.2,2.2,1.1]]],
	["Van_01_base_F", [[-1.2,-3.5,-1.9],[1.2,2.2,0.9]]],
	["Offroad_01_armed_base_F", [[-1.3,-2.9,-2.3],[1.2,2.9,0.3]]],
	["Offroad_01_base_F", [[-1.1,-3,-1.8],[1.1,2.7,0.5]]],
	["SUV_01_base_F", [[-1.1,-3.1,-1.7],[1.1,2.4,0.5]]],
	["MRAP_01_gmg_base_F", [[-1.3,-4.7,-2.9],[1.3,1.7,0.9]]],
	["MRAP_01_base_F", [[-1.3,-4.8,-2.3],[1.3,1.7,0.7]]],
	["MRAP_02_hmg_base_F", [[-1.6,-4.9,-2.9],[1.6,1.7,1]]],
	["MRAP_02_base_F", [[-1.6,-4.9,-2.4],[1.6,1.7,0.8]]],
	["MRAP_03_hmg_base_F", [[-1.4,-3.3,-2.4],[1.4,2.6,0.5]]],
	["MRAP_03_base_F", [[-1.4,-3.3,-1.9],[1.4,2.6,1]]],
	["B_Truck_01_ammo_F", [[-1.2,-4.8,-2],[1.3,5.1,1.7]]],
	["B_Truck_01_box_F", [[-1.3,-5.8,-2.3],[1.3,5.2,2.3]]],
	["B_Truck_01_fuel_F", [[-1.2,-5.1,-2],[1.3,5,1.7]]],
	["B_Truck_01_medical_F", [[-1.4,-5.1,-2.2],[1.1,5.1,1.4]]],
	["B_Truck_01_Repair_F", [[-1.3,-5.8,-2.3],[1.3,5.2,2.3]]],
	["B_Truck_01_mover_F", [[-1.2,-4.2,-2],[1.3,4.8,1.2]]],
	["Truck_01_base_F", [[-1.2,-5.1,-2.3],[1.3,5.1,1.4]]],
	["O_Truck_02_ammo_F", [[-1.4,-5.4,-2.4],[1.3,2.8,1.1]]],
	["O_Truck_02_medical_F", [[-1.5,-3.8,-2.4],[1.2,4.1,1.1]]],
	["O_Truck_02_box_F", [[-1.4,-5.4,-2.4],[1.3,2.8,1.1]]],
	["O_Truck_02_fuel_F", [[-1.3,-5.1,-2.4],[1.3,2.8,0.9]]],
	["I_Truck_02_ammo_F", [[-1.4,-5.4,-2.4],[1.3,2.8,1.1]]],
	["I_Truck_02_medical_F", [[-1.5,-3.8,-2.4],[1.2,4.1,1.1]]],
	["I_Truck_02_box_F", [[-1.4,-5.4,-2.4],[1.3,2.8,1.1]]],
	["I_Truck_02_fuel_F", [[-1.3,-5.1,-2.4],[1.3,2.8,0.9]]],
	["Truck_02_base_F", [[-1.3,-3.8,-2.4],[1.4,4.1,1.1]]],
	["O_Truck_03_ammo_F", [[-1.6,-5.3,-2.1],[1.7,3.5,1.4]]],
	["O_Truck_03_device_F", [[-1.6,-5.3,-2.1],[1.7,3.5,1.3]]],
	["O_Truck_03_fuel_F", [[-1.6,-5.2,-2.2],[1.7,3.5,1.2]]],
	["O_Truck_03_medical_F", [[-1.6,-5.1,-2.4],[1.7,3.7,0.9]]],
	["O_Truck_03_repair_F", [[-1.6,-5.3,-2.1],[1.7,3.5,1.3]]],
	["Truck_03_base_F", [[-1.6,-5.1,-2.4],[1.7,3.7,1]]],
	["APC_Wheeled_01_base_F", [[-1.5,-4.8,-2.4],[1.5,2.8,1]]],
	...
	["UAV_02_base_F", [[-5.1,-3.4,-1.6],[5.1,2.5,0.9]]],
	["UGV_01_rcws_base_F", [[-0.8,-2.1,-2],[1.7,2.1,0.2]]],
	["UGV_01_base_F", [[-0.8,-2.1,-2],[1.7,2.1,-0.2]]],
...
// Here is the intersect scanner, which is used in the editor (comments must be removed). The resulting array is copied into the clipboard.
...
[] spawn
{
	_precision = 0.1; // change this for higher/lower precision
	_lineColor1 = [0,1,0,1];
	_lineColor2 = [1,0,0,1];
...

	{
		...
		// intersect is used as a backup because lineIntersects doesn't detect some heli blades, "GEOM" option is the most accurate for those
		...
		[_classesBBox, [_kind, [_minReal,_maxReal]]] call BIS_fnc_arrayPush;
	...
	copyToClipboard str _classesBBox;
};
*/